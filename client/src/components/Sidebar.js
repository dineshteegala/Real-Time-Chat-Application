...
const Sidebar = () => {
    ...
    return (
        <div className='w-full h-full grid grid-cols-[48px,1fr] bg-blue-100'>
            ...
            <div className='w-full'>
                <div className='h-16 flex items-center'>
                    <h2 className='text-xl font-bold p-4 text-slate-800'>Contacts</h2>
                    <hr></hr>
                </div>
                <div className='bg-slate-200 h-[1px]'></div> {/* This is the line */}
